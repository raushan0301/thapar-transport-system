...
const AuthorityReviewRequest = () => {
    ...
    const fetchRequest = async () => {
        try {
            ...
            // Check if user is authority and request is routed to them
        ...
        try {
            ...
            const { error: approvalError } = await supabase
                ...
                .insert([{
                    request_id: id,
                    approver_id: user.id,
                    approver_role: user.role?.toLowerCase(),
                    action: 'approved',
                    comment: null,
            ...
            // Update request status - back to admin for vehicle assignment
            ...
            toast.success('Request approved! Forwarded for vehicle assignment.');
            navigate('/authority/pending');
        } catch (err) {
            console.error('Error:', err);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            <DashboardLayout>
                ...
                <div className="mb-8 animate-slideDown">
                    <button onClick={() => navigate('/authority/pending')} className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 mb-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600">Request Number: <span className="font-semibold text-indigo-600">{request.request_number}</span></p>
                        </div>
                ...
                {/* Info Box */}
                <div className="mt-6 bg-indigo-50 border border-indigo-200 rounded-xl p-4 animate-slideUp" style={{ animationDelay: '400ms' }}>
                    <p className="text-sm text-indigo-800">
                        <strong>Note:</strong> This request has been escalated to you for special approval. Approving will forward it for vehicle assignment. Rejecting will notify all parties with your reason.
                    </p>
                </div>
            </DashboardLayout>
...
export default AuthorityReviewRequest;
