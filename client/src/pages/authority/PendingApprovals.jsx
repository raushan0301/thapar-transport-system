        ...
        try {
            ...
            const { error: approvalError } = await supabase
                ...
                .insert({
                    ...
                    approver_id: user.id,
                    approver_role: profile.role, // director, deputy_director, or dean
                    action: 'approved',
        ...
        try {
            ...
            const { error: notifError } = await supabase
                ...
                .insert({
                    ...
                    message: `Your request ${selectedRequest.request_number} has been rejected by ${profile.role}`,
                    type: 'rejection',
            ...
            >
                <div className="space-y-4">
                    <p className="text-gray-600">
                        Are you sure you want to approve request <strong>{selectedRequest?.request_number}</strong>?
                    </p>
